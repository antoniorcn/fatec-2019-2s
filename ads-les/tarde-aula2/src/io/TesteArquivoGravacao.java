...
public class TesteArquivoGravacao {
	...
	public static void main(String[] args) {
		System.out.println("Inicio do teste de gravação de arquivo");
		try { 
			...
			System.out.println(
				String.format("Caminho é de um arquivo ?: %s", f.isFile()));
			System.out.println(
				String.format("Caminho é de um pasta ?: %s", f.isDirectory()));
